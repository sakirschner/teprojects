...
INSERT INTO survey_result(parkcode, emailaddress, state, activitylevel) VALUES ('GNP', 'test@test.com', 'MI', 'restraint');
INSERT INTO survey_result(parkcode, emailaddress, state, activitylevel) VALUES ('GNP', 'test2@test.com', 'TX', 'restraint');
INSERT INTO survey_result(parkcode, emailaddress, state, activitylevel) VALUES ('ENP', 'test3@test.com', 'CO', 'restraint');
INSERT INTO survey_result(parkcode, emailaddress, state, activitylevel) VALUES ('YNP', 'test5@test.com', 'MI', 'restraint');
INSERT INTO survey_result(parkcode, emailaddress, state, activitylevel) VALUES ('YNP', 'test6@test.com', 'MI', 'restraint');
INSERT INTO survey_result(parkcode, emailaddress, state, activitylevel) VALUES ('YNP', 'test7@test.com', 'MI', 'restraint');
INSERT INTO survey_result(parkcode, emailaddress, state, activitylevel) VALUES ('GNP', 'test8@test.com', 'TX', 'restraint');
INSERT INTO survey_result(parkcode, emailaddress, state, activitylevel) VALUES ('GNP', 'test9@test.com', 'TX', 'restraint');
INSERT INTO survey_result(parkcode, emailaddress, state, activitylevel) VALUES ('GNP', 'test10@test.com', 'TX', 'restraint');
INSERT INTO survey_result(parkcode, emailaddress, state, activitylevel) VALUES ('GNP', 'test11@test.com', 'TX', 'restraint');



SELECT park.parkname, park.state, park.yearfounded, count(survey_result.parkcode) as count FROM survey_result
JOIN park ON park.parkcode = survey_result.parkcode
GROUP BY survey_result.parkcode, park.parkname, park.state, park.yearfounded
